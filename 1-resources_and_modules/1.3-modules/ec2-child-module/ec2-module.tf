resource "aws_instance" "ec2_instance" {
  ...
  subnet_id              = element(tolist(data.aws_subnets.subnet_id.ids), count.index) # this prevent a scenario where the number of instances is not a multiple of the number of subnets.
